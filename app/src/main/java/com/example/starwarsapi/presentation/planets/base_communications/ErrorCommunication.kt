...
class ErrorCommunication(
    ...
    private val communication: PlanetsCommunication,
    private val domainExceptionMapper: DomainException.Mapper.Factory<List<ItemUi>>
) : HandleError {
